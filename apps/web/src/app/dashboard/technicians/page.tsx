    ...
    <div style={{ padding: "1rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      {loading ? (
        ...
        <ul style={{ listStyle: "none", padding: 0 }}>
          {technicians.map((t) => (
            <li key={t.person_id} style={{ border: "1px solid #e5e7eb", borderRadius: "0.5rem", padding: "1rem", marginBottom: "0.75rem", background: "white" }}>
              <Link href={`/dashboard/technicians/${t.person_id}`} style={{ textDecoration: "none", color: "inherit" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                  ...
                  <span style={{
                    background: t.technician_status === "ACTIVE" ? "#dcfce7" : "#fef2f2",
                    color: t.technician_status === "ACTIVE" ? "#166534" : "#dc2626",
                ...
                {t.license_number && <div style={{ marginTop: "0.5rem", fontSize: "0.875rem", color: "#6b7280" }}>Matrícula: {t.license_number}</div>}
                <div style={{ marginTop: "0.5rem", display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
                  {t.identifications.map((ident) => (
                    <span key={ident.id} style={{ background: "#f0fdf4", color: "#166534", padding: "0.25rem 0.5rem", borderRadius: "0.25rem", fontSize: "0.75rem" }}>
